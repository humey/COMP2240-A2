// COMP2240 - Assignment 2 Q2 Covid safe shop
// Keeylan Hume - C3320396
// Customer thread Q1
...
public class Customer extends Thread{
    ...
    public Customer(int arriveTime, int customerID, int eatingTime, IceCreamShop shop, ClockTime ct) {
